...
<head>
    ...
    <meta name="description" content="Iran Focus - Political analysis and news.">
    ...
    <header class="site-header">
        <div class="container nav-top">
            <a class="brand" href="/articles">
                <img class="brand-logo" src="<?= htmlspecialchars($logoPath, ENT_QUOTES, 'UTF-8') ?>" alt="Iran Focus logo">
